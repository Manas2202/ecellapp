    ...
    public void activity(View view) {
        switch (view.getId()) {
            case R.id.deparment:
                ...
                break;
            case R.id.teamchat1:
                Intent fullTeamChat = new Intent(DashboardActivity.this, FullteamchatActivity.class);
                fullTeamChat.putExtra("groupName", groupName);
                fullTeamChat.putExtra("userName", userName);
                startActivity(fullTeamChat);
